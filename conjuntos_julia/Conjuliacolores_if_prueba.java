...
class Conjuliacolores_if_prueba
{
    ...
    public static void main(String args[])
    {
        ...
        for (s=2; s > 0; s=s - 2)
        {
                    ...
                    else
                    {
                        ...
                        if (con > 100)
                        {
                            ...
                            if ((x < 4000 && y < 4000) && (x > 0 && y > 0))
                                img.setRGB(x, y, col[con * ((total * 2) - 1) / 738]);
                            con=0;
                        }
                    }
                }
            ...
            File f = new File("conj_col_if_prueba" + (intervalo1 * 10) + ".png");
            try {
    ...
    public static void colores()
    {
        ...
        int     xi=0, xf=0, yi=0, yf=0, zi=0, zf=0, colore=0, xp, yp, zp, xv=0, yv=0, zv=0, con=0, ci, cf, xi2=0, xf2=255, yi2=0, yf2=255, zi2=0, zf2=255;
